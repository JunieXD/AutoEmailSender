              ...
              {overview.mentor.match_context ? (
                ...
                >
                  <span className="font-semibold text-primary">
                    {overview.mentor.match_context.uses_group_match_source
                      ? `组内匹配统一依据 ${overview.mentor.match_context.source_identity_name}`
                      : `匹配依据当前身份 ${overview.mentor.match_context.source_identity_name}`}
                  </span>
                  <span>
                    默认材料：
                    {overview.mentor.match_context.source_material_name || '尚未设置'}
                  </span>
                  {overview.mentor.match_context.stale_result_count > 0 ? (
