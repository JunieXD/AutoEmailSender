...
_COLLECTION_FILTER_FIELDS: Final[dict[str, frozenset[str]]] = {
    ...
    "crawler.jobs.list": frozenset({"id", "university", "school", "start_url", "start_urls", "entry_type", "llm_profile_id", "llm_context", "status", "progress_current", "progress_total", "error_message", "page_count", "candidate_count", "latest_event_message", "input_tokens", "output_tokens", "cached_tokens", "total_tokens", "duration_seconds", "created_at", "updated_at", "deleted_at"}),
