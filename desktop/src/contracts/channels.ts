export const DESKTOP_IPC_CHANNELS = {
  ...
  betaDiagnosticsGetStatus: "beta-diagnostics:get-status",
  betaDiagnosticsClear: "beta-diagnostics:clear",
  betaDiagnosticsMarkProblem: "beta-diagnostics:mark-problem",
  betaDiagnosticsExport: "beta-diagnostics:export",
