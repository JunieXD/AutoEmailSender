...
from app.modules.crawler.runtime.models import CrawlerWorkKind
from app.modules.crawler.runtime.token_usage import record_crawler_token_usage


class CrawlerRuntimeTokenUsageTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_record_usage_also_updates_current_run_for_frontend_summary(
        self,
    ) -> None:
        fd, db_path = tempfile.mkstemp(suffix=".db")
        os.close(fd)
    ...
    async def test_same_claim_usage_is_recorded_once_and_attached_to_run(self) -> None:
        ...
        try:
            ...
            first = await record_crawler_token_usage(
                session_factory,
                job_id=job_id,
            ...
            second = await record_crawler_token_usage(
                session_factory,
                job_id=job_id,
                worker_kind=CrawlWorkerKind.PAGE,
                work_item_id=task_id,
