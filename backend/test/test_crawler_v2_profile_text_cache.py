...
class ProfileTextCacheTests(unittest.TestCase):
    def test_evicts_least_recently_used_entry_at_capacity(self) -> None:
        ...
        first = (1, 10, 1000, 100, "https://example.edu/first")
        second = (1, 10, 1000, 101, "https://example.edu/second")
        third = (1, 10, 1000, 102, "https://example.edu/third")
    ...
    def test_character_budget_evicts_old_entries_and_rejects_oversized_value(self) -> None:
        ...
        first = (1, 10, 1000, 100, "first")
        second = (1, 10, 1000, 101, "second")
        oversized = (1, 10, 1000, 102, "oversized")
    ...
    def test_candidate_and_job_cleanup_do_not_remove_unrelated_entries(self) -> None:
        ...
        target = (1, 10, 1000, 100, "target")
        same_candidate_other_factory = (2, 10, 1000, 100, "other-factory")
        same_job_other_candidate = (1, 10, 1000, 101, "other-candidate")
        other_job = (1, 11, 1001, 100, "other-job")
        for key in (target, same_candidate_other_factory, same_job_other_candidate, other_job):
            cache.put(key, key[4])

        previous_run = (1, 10, 999, 100, "previous-run")
        cache.put(previous_run, "previous-run")
        ...
        self.assertNotIn(previous_run, cache)
