...
class CrawlJobModelTests(unittest.TestCase):
    def test_page_task_status_constants_are_stable(self) -> None:
        ...
        self.assertEqual(
            CrawlPageTaskStatus.SKIPPED_DUPLICATE.value, "skipped_duplicate"
        )
    ...
    def test_enrichment_task_status_constants_are_stable(self) -> None:
        ...
        self.assertEqual(
            CrawlCandidateEnrichmentTaskStatus.PROCESSING.value, "processing"
        )
        self.assertEqual(
            CrawlCandidateEnrichmentTaskStatus.SUCCEEDED.value, "succeeded"
        )
        ...
        self.assertEqual(
            CrawlCandidateEnrichmentTaskStatus.FAILED_TERMINAL.value, "failed_terminal"
        )
    ...
    def test_status_constants_are_stable(self) -> None:
        ...
        self.assertEqual(
            CrawlJobStatus.PARTIALLY_COMPLETED.value, "partially_completed"
        )
    ...
    def test_chunk_status_constants_are_stable(self) -> None:
        ...
        self.assertEqual(
            CrawlPageChunkStatus.FAILED_RETRYABLE.value, "failed_retryable"
        )
