...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "token_estimate", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column("text_start_offset", sa.Integer(), nullable=True),
        sa.Column("text_end_offset", sa.Integer(), nullable=True),
        sa.Column(
            "overlap_prefix", sa.Boolean(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column(
            "overlap_suffix", sa.Boolean(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column(
            "split_depth", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["job_id"],
            ["crawl_jobs.id"],
            name=op.f("fk_crawl_page_chunks_job_id_crawl_jobs"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["page_id"],
            ["crawl_pages.id"],
            name=op.f("fk_crawl_page_chunks_page_id_crawl_pages"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_crawl_page_chunks")),
        sa.UniqueConstraint(
            "job_id", "chunk_id", name=op.f("uq_crawl_page_chunks_job_chunk_id")
        ),
    )
    op.create_index(
        op.f("ix_crawl_page_chunks_job_id"),
        "crawl_page_chunks",
        ["job_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_crawl_page_chunks_page_id"),
        "crawl_page_chunks",
        ["page_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_crawl_page_chunks_parent_chunk_id"),
        "crawl_page_chunks",
        ["parent_chunk_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_crawl_page_chunks_chunk_hash"),
        "crawl_page_chunks",
        ["chunk_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_crawl_page_chunks_status"),
        "crawl_page_chunks",
        ["status"],
        unique=False,
    )
    ...
    with op.batch_alter_table("crawl_candidates") as batch_op:
        ...
        batch_op.add_column(
            sa.Column("identity_key", sa.String(length=1000), nullable=True)
        )
        ...
        batch_op.create_index(
            batch_op.f("ix_crawl_candidates_identity_key"),
            ["identity_key"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_crawl_candidates_source_chunk_id"),
            ["source_chunk_id"],
            unique=False,
        )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_crawl_page_chunks_chunk_hash"), table_name="crawl_page_chunks"
    )
    op.drop_index(
        op.f("ix_crawl_page_chunks_parent_chunk_id"), table_name="crawl_page_chunks"
    )
